...
public class MingguPompaAirBersihAdapter extends RecyclerView.Adapter<MingguPompaAirBersihAdapter.ViewHolder> {
    private List<MingguPompaAirBersihEntity> list;

    public MingguPompaAirBersihAdapter(List<MingguPompaAirBersihEntity> list) {
        this.list = list;
    }

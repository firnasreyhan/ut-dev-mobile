...
public class SignUpViewModel extends AndroidViewModel {
    ...
    public MutableLiveData<SignUpResponse> signUp(String namaLengkap, String username, String role, String departemen, String divisi, String password) {
        return repository.postSignUp(namaLengkap, username, role, departemen, divisi, password, updateToken(username));
    }

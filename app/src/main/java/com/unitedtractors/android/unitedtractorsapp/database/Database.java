...
@androidx.room.Database(entities = {MingguPompaAirBersihEntity.class, DetailMingguPompaAirBersihEntity.class, MingguRuangMeetingEntity.class, DetailMingguRuangMeetingEntity.class}, version = 1, exportSchema = false)

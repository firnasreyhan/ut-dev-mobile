...
import com.unitedtractors.android.unitedtractorsapp.view.activity.form.checklist_pompa_pond.LokasiPompaPondActivity;
...
public class ChecklistForHydrantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.materialButtonSelanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkData()) {
                    Intent intent = new Intent(v.getContext(), SystemPemipaanActivity.class);
